...
<html lang="en">
    ...
    <head>
        ...
        <link href="/ClearDu/admin/assets/global/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css" />
        
        <link href="/ClearDu/admin/assets/global/plugins/bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />

        <link href="/ClearDu/admin/assets/pages/css/login.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="logo container-fluid">
            ...
            <!--    <img src="<?php echo $web_url;?>admin/assets/images/logo.png" alt="" style="width: 150px" />-->
            <!--</a>-->
            </div>
            <div class="col-md-4">
                <img src="../images/ClearDu.png" alt="" style="width: 150px; margin-top: 12px;" />
            </div>
            <div class="col-md-4">
...
<![endif]-->
        ...
        <script>
          ...
          <script src="/ClearDu/admin/assets/global/plugins/jquery.min.js" type="text/javascript"></script>
        <script src="/ClearDu/admin/assets/global/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
        
        <script src="/ClearDu/admin/assets/global/scripts/app.js" type="text/javascript"></script>
        <script src="/ClearDu/admin/assets/pages/scripts/login.js" type="text/javascript"></script>
