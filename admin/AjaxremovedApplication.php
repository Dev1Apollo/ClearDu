...
//customer_city_id in  (" . $strLocationID . ") and
    $filterstr = "SELECT * FROM `bulkremovalapplication` " . $where . " and  is_assignto_am ='1' and am_accaptance='1' and bulkremovalapplication.isDelete=0 ";
    $countstr = "SELECT count(*) as TotalRow FROM  `bulkremovalapplication` " . $where . " and   is_assignto_am ='1' and am_accaptance='1' and bulkremovalapplication.isDelete=0 ";
