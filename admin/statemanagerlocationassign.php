                                ...
                                <div class="portlet light ">
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                            <input type="hidden" value="statemanagerlocationstatedistrict" name="action" id="action">
                                            <input type="hidden" value="<?php echo $_REQUEST['token'] ?>" name="iStateManagerId" id="iStateManagerId">
...
//        }
        function getlocation() {
            ...
            var urlp = '<?php echo $web_url; ?>admin/findStateManagerlocation.php?sId=' + sId + '&iStateManagerId=' + iStateManagerId;
            $.ajax({
                type: 'POST',
                url: urlp,
                success: function (data) {
    ...
    <script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == 1)
                    {
                        ...
                        //window.location.href = '<?php echo $web_url; ?>admin/statemanagerlocationassign.php?token=' + iStateManagerId;
                    }
                }
        ...
        function PageLoadData(Page) {
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>admin/AjaxStateManagerStateDistrictLocation.php",
                data: {action: 'ListUser', Page: Page, iStateManagerId: iStateManagerId},
