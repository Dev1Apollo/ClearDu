...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | State Manager </title>
                                ...
                                <div class="portlet light ">
                                    <div class="portlet-title">
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">List of State Manager</span>
                                        </div>
                                        <a href="<?php echo $web_url;?>admin/AddStatemanager.php" class="btn blue" style="float: right;" title="Add State Manager">ADD State Manager</a>
                                    </div>
        ...
        <script type="text/javascript">
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url;?>admin/AjaxStatemanager.php",
