...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Add State Manager </title>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase"> Add State Manager</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="AddStatemanager" name="action" id="action">
                                                <div class="form-body">

                                                    <div class="form-group col-md-4">
                                                        <label for="form_control_1">Employee Name</label>
                                                        <input name="strEmployeeName" id="strEmployeeName"  class="form-control" placeholder="Enter Your Employee Name" type="text" required="">
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input name="strEmail" id="strEmail"  class="form-control" placeholder="Enter Your Email Address"  type="email">
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label for="form_control_1">Phone No.</label>
                                                        <input name="strPhoneNo" id="strPhoneNo"  class="form-control" placeholder="Enter Your Phone No." pattern="[0-9]{11}" type="text">
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                        <label for="form_control_1">Mobile No.</label>
                                                        <input name="strMobileNo" id="strMobileNo"  class="form-control" placeholder="Enter Your Mobile No." pattern="[7-9]{1}[0-9]{9}" type="text">
                                                    </div>
                                                    <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-group col-md-4">
                                                        ...
                                                        <input name="strPassword" id="strPassword"  class="form-control" placeholder="Enter Your Password." type="text" required="">
                                                    </div>
                                                    <div class="form-group col-md-4">
    ...
    <script src="assets/bootstrap-multiselect.js" type="text/javascript"></script>
        ...
        <script type="text/javascript">
            ...
            function chkLoginId(ID)
            {
                ...
                var urlp = '<?php echo $web_url; ?>admin/findstatemanagerLoginID.php?ID=' + q;
                $.ajax({
                    type: 'POST',
                    url: urlp,
