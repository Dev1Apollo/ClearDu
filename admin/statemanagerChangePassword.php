...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | State Manager Change Password </title>
                    ...
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            <li>
                              ...
                              <li>
                                  <a href="<?php echo $web_url;?>admin/statemanager.php">List Of State Manager</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            
                            <li>
                                <span> State Manager Change Password</span>
                            </li>
                        </ul>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase">State Manager Change Password</span>
                                        ...
                                        <div class="portlet-body form">
                                            <form  role="form"  method="POST"  action="" name="fromchangepassword"  id="fromchangepassword" enctype="multipart/form-data" class="margin-bottom-40">
                                                <input type="hidden" value="statemanagerChangePassword" name="action">
                                                <input type="hidden" name="iStateManagerId" id="iStateManagerId" value="<?php echo $row['iStateManagerId'];?>">
                                                <div class="form-body">

                                                   
                                                    <div class="form-group form-md-line-input  col-md-4">
                                                        <label for="form_control_1">New Password</label>
                                                        <input type="password"  id="strPassword" name="strPassword" class="form-control" placeholder="Enter your New Password" required>
                                                    </div>
                                                    <div class="form-group form-md-line-input  col-md-4">
...
//                                }
                    ...
                    if (ps == "")
                        $("#strPassword").attr("placeholder", "Enter New Password please");
                    if (cps == "")
