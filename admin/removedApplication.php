    ...
    <body class="page-container-bg-solid page-boxed">
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="portlet-body form">
                                    ...
                                    <form  role="form"  method="POST"  action="" name="frmSearch"  id="frmSearch" enctype="multipart/form-data">
                                        <input type="hidden" value="AddadminLedger" name="action" id="action">
        ...
        <script type="text/javascript">
            ...
            function PageLoadData(Page) {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo $web_url; ?>admin/AjaxremovedApplication.php",
        ...
        <script type="text/javascript">
            ...
            function checkb4submit()
            {
                ...
                var toDate = $('#toDate').val();
                 var agency = $('#agency').val();
                var completedstatus = $('#completedstatus').val();
                var strURL = "removedApplicationReportDownload.php?FormDate=" + FormDate + "&toDate=" + toDate + "&completedstatus=" + completedstatus + "&agency=" + agency;
                //alert(strURL);           
