...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Add Agency Manager </title>
    ...
    <body class="page-container-bg-solid page-boxed">
                ...
                <div class="page-content">
                    <div class="container">
                        <ul class="page-breadcrumb breadcrumb">
                            ...
                            <li>
                                <a href="<?php echo $web_url; ?>admin/LocationEmployee.php">List Of Agency Manager</a>
                                <i class="fa fa-circle"></i>
                            </li>
                            <li>
                                <span>Add Agency Manager</span>
                            </li>
                        </ul>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase"> Add Agency Manager</span>
                                            </div>
                                        </div>
                                            ...
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div id="divlatlong" style="display:none;">
                                                        <div class="form-group col-md-4">
                                                            <label for="form_control_1"> Latitude </label><div id="errordiv"></div>
                                                            <input name="strLatitude" id="strLatitude"  class="form-control" placeholder="Enter Your Latitude." type="text" required="">
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="form_control_1"> Longitude </label><div id="errordiv"></div>
                                                            <input name="strLongitude" id="strLongitude"  class="form-control" placeholder="Enter Your Longitude." type="text" required="">
                                                        </div>
                                                    </div>
        ...
        <script type="text/javascript">
            ...
            {
                var q = $('#LoginID').val();
                var urlp = '<?php echo $web_url; ?>admin/findagencymanagerLoginID.php?ID=' + q;
                $.ajax({
                    type: 'POST',
                    url: urlp,
                    success: function (data) {
