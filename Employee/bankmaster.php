...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title><?php echo $ProjectName; ?> | Edit Bank Master </title>
                                    ...
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                ...
                                                <span class="caption-subject bold uppercase" id="state">Add Bank Master</span>
                                            </div>
                                        </div>
                                            ...
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="strBankName" id="strBankName"  class="form-control" placeholder="Enter Bank Name" required="" type="text">
                                                    </div>
                                ...
                                <div class="col-md-8">
                                    <div class="portlet light ">
                                        <div class="portlet-title">
                                            <div class="caption font-red-sunglo">
                                                <i class="icon-settings font-red-sunglo"></i>
                                                <span class="caption-subject bold uppercase">List of Bank Master</span>
                                            </div>
                                        </div>
                                        <div class="portlet-body form">
        ...
        <script type="text/javascript">
            ...
            function setEditdata(id)
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url;?>Employee/querydata.php',
                    data: {action: "GetEmployeeBank", ID: id},
                    success: function (response) {
                        document.getElementById("state").innerHTML = "EDIT Bank Master";
                        $('#loading').css("display", "none");
                        var json = JSON.parse(response);
                        $('#strBankName').val(json.strBankName);
                        $('#action').val('EditBanbk');
                        $('<input>').attr('type', 'hidden').attr('name', 'iBankId').attr('value', json.iBankId).attr('id', 'iBankId').appendTo('#frmparameter');
                    }
                });
            }
            ...
            function deletedata(task, id)
            {
                ...
                if (confirm(errMsg)) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo $web_url;?>Employee/AjaxBank.php",
