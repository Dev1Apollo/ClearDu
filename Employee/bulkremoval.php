...
<html lang="en">
    <head>
        ...
        <title> <?php echo $ProjectName ?> | Bulk Removal </title>
    ...
    <body class="page-container-bg-solid page-boxed">
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase">Bulk Removal</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                                <input type="hidden" value="Bulkremoval" name="action" id="action">
                                                <div class="form-body">
                                                    <div class=" col-md-12">
        ...
        <script type="text/javascript">
            ...
            $('#frmparameter').submit(function (e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo $web_url; ?>Employee/bulkremovalquerydata.php',
