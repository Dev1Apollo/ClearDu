...
if ($_POST['action'] == 'ListUser') {
    ...
    $where.=" and  fos_completed_status=20";
    ...
    if ($_SESSION['Type'] == 'Central Manager') {
        $filterstr = "SELECT * FROM `application` " . $where . " and is_assignto_am ='1' and am_accaptance='1' and application.isDelete=0 and fosid > 0";
    } else {
