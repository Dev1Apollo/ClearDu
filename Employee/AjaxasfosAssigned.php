...
if ($_REQUEST['toDate'] != NULL && isset($_REQUEST['toDate'])) {
    ...
    $filterstr = "SELECT * FROM `application` " . $where . " and customer_city_id in  (" . $strLocationID . ") and is_assignto_am ='1' and am_accaptance='1' and application.isDelete=0 and fosid > 0 and agencyid='" . $_SESSION['agencyname'] . "'    ";
    $countstr = "SELECT count(*) as TotalRow FROM  `application` " . $where . " and customer_city_id in  (" . $strLocationID . ") and  is_assignto_am ='1' and application.isDelete=0 and am_accaptance='1'  and fosid > 0 and agencyid='" . $_SESSION['agencyname'] . "'   ";
