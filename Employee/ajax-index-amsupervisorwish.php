...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterrt = "SELECT count(*) as totalcount,application.fos_completed_status FROM `application` where application.customer_city_id = '" . $_REQUEST['id1'] . "'  and application.am_accaptance = 1 ".$where." group by application.fos_completed_status";
                        ...
                        <div class="col-md-12" style="margin-top: 15px">
                            <table class="table table-bordered dt-responsive" width="100%">
                                ...
                                <tr style="background-color: #DBEEF3; color: #000 !important ;">
                                    ...
                                    <td class="text-center text-light">
                                        <a onclick="checkb4submit('<?php echo $_REQUEST['id1']; ?>', 'amDisposition Summary', '<?php echo $Dispositionwise['fos_completed_status']; ?>',<?= $iBankId ?>);"><?php echo $Dispositionwise['totalcount']; ?></a>
                                    </td>
                                </tr>
                                   <?php
        }
...
<script type="text/javascript">
    ...
    function checkb4submit(locationid, counttype, fos_completed_status,bankid)
    {
        var strURL = "cmindexcountReportDownload.php?locationid=" + locationid + "&counttype=" + counttype + "&fos_completed_status=" + fos_completed_status+"&bankid="+ bankid;
