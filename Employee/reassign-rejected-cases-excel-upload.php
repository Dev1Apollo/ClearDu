                            ...
                            if ($icounter == $AgencyColumnCounter) {
								...
								if (trim($Agencyname) != "") {
                                    ...
                                    if (mysqli_num_rows($agencyname) == 0) {
										$errorString .= "Restricted for Account No " . $LANNUMBER . " & Agencyname =" . $agency . " not match <br/>";
                                    } else {
										...
										if($agencyid != 0){
											if($agencyid == $rowagencyname['agencyname']){
												...
												$errorString .= "Restricted for Account No " . $LANNUMBER . " & Fos Agencyname =" . $agency . " not match <br/>";
											}
										}
                                    }
                                }
