                                ...
                                <div class="portlet light ">
                                    ...
                                    <div class="portlet-body form">
                                        ...
                                        <form  role="form"  method="POST"  action="" name="frmparameter"  id="frmparameter" enctype="multipart/form-data">
                                            <input type="hidden" value="cmagancyuserlocationstatedistrict" name="action" id="action">
...
<?php include_once './footer.php'; ?>
    ...
    <script type="text/javascript">
        function finddistrict()
        {
            ...
            var urlp = '<?php echo $web_url; ?>Employee/finddistrict.php?sId=' + q;
            $.ajax({
                type: 'POST',
                url: urlp,
        ...
        function getlocation() {
            ...
            var urlp = '<?php echo $web_url; ?>Employee/find-cm-agencyuser-location.php?did=' + district + '&sId=' + sId + '&agencyid=' +agencyid + '&agencymanagerid=' + agencymanagerid;
            $.ajax({
                type: 'POST',
                url: urlp,
                success: function (data) {
    ...
    <script type="text/javascript">
        ...
        function checkclose() {
            window.location.href = '<?php echo $web_url; ?>Employee/cm-agencyuserlocationassign.php';
        }
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response == 1)
                    {
                        ...
                        window.location.href = '<?php echo $web_url; ?>Employee/cm-agencyuserlocationassign.php?token=' + agencyid;
                    }
                }
        ...
        var agencyid = $('#agencyid').val();
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo $web_url; ?>Employee/Ajax-cm-agencyuserstatedistrictlocation.php",
