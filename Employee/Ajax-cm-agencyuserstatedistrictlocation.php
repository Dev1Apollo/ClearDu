...
if ($_POST['action'] == 'ListUser') {
    ...
    $filterstr = "SELECT * FROM `agencymanagerlocation`  where iagencymanagerid= '" . $_REQUEST['agencyid'] . "' and isDelete='0'  and  istatus='1' order by  agencymanagerlocationid desc";
    $countstr = "SELECT count(*) as TotalRow FROM `agencymanagerlocation`   where  iagencymanagerid= '" . $_REQUEST['agencyid'] . "' and isDelete='0' and  istatus='1' ";
